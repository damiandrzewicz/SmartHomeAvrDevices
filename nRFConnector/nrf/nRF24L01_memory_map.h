...
//'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''//
//REGISTERS LIST OF nRF24L01 - SPIS REJESTR�W MODU�U nRF24L01//
//,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,//
...
#define SETUP_AW    0x03	 //SETUP ADRESSE WIDTH - USTAL D�UGO�C ADRESU (3-5 BAJT�W) WSP�LNE DLA KA�DEGO Z 6 STRUMIENI DANYCH (DATA PIPES)
...
#define FIFO_STATUS 0x17     //FIFO STATUS - STATUS STOS�W NADAWCZYCH I ODBIORCZYCH
...
//"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""//
//LIST OF CONFIGURATION BITS IN EACH REGISTER - LISTA BIT�W KONFIGURACYJNYCH W KA�DYM REJESTRZE//
//.............................................................................................//
...
#define CRCO             2  //CRC ENCHODING SCHEME - IF 0 -> crc == 1 BYTE; IF 1 CRC == 2 BYTES; LICZBA BAJT�W UMY KONTROLNEJ CRC: JE�ELI 0 -> CRC TO 1 BAJT, JE�ELI 1 -> CRC TO 2 BAJTY
#define PWR_UP           1  //1 - POWER UP, 0 - POWER DOW; 1 - W��CZ MODU�, 0 - WY��CZ MODU�
#define PRIM_RX          0  //RX/TX CONTROL: 1 - RECEIVING, 0 - TRANSMITING; KONTROLA ODBI�R/NADAWANIE: 1 - OBI�R, 0 - NADAWANIE
...
// |EN_RXADDR|
#define ERX_P5           (1<<5)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
#define ERX_P4           (1<<4)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
#define ERX_P3           (1<<3)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
#define ERX_P2           (1<<2)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
#define ERX_P1           (1<<1)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
#define ERX_P0           (1<<0)  //ENABLE DATA PIPE 5 - W��CZ STRUMIE� DANYCH NR 5
...
#define AW_5BYTE         3  //ADDRES WIDTH = 5 BYTES; SZEROKO�C ADRESU = 5 BAJT�W
...
#define RF_DR_LOW        5  //RF DATA RATE LOW  - M�ODSZY BIT W DWUBITOWYM "S�OWIE" DO USTAWIANIA PR�DKO�CI TRANSMISJI
#define RF_DR_HIGH       3  //RF DATA RATE HIGH - STARSZY BIT W DWUBITOWYM "S�OWIE" DO USTAWIANIA PR�DKO�CI TRANSMISJI
...
#define MAX_RT      4     //MAXIMUM ACCOUNT OF RETRANSMISION ACHIVED - OSIAGNI�TO MAKSYMALN� ILOSC RETRANSMISJI
...
#define NOP                  0xFF   //NOP - NIC NIE R�B - PO WYS�ANIEU TEGO BAJTU NRF ZWRACA REJESTR STATUS
