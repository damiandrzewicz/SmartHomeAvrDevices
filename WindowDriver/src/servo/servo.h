...
//	uint32_t calculateTargetEncoderValue(uint8_t percent, WindowData::Visibility vis = WindowData::Visibility::None);
...
//
//	//int32_t m_maxEncoderCounter = 0;
//	//uint16_t m_singleEncoderStep = 0;
//	//uint32_t m_setEncoderCounter = 0;
//
